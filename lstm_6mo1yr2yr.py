...
fileName = "/content/drive/MyDrive/6889proj/Dataset/aapl_history_1yr.csv"
...
data = df.select('Open','High','Low','Volume','Sentiment_Score','Close').toPandas()
print(data)
...
fileName = "/content/drive/MyDrive/6889proj/Dataset/aapl_history_2yr.csv"
